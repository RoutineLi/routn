...
namespace Routn{
    ...
    class ITranscation : public ISQLUpdate{
    public:
        using ptr = std::shared_ptr<ITranscation>;
        virtual ~ITranscation() {}
    ...
    public:
        ...
        virtual int getErrno() = 0;
        virtual std::string getErrStr() = 0;
        virtual ITranscation::ptr openTransaction(bool auto_commit = false) = 0;
    };
}
